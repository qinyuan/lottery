...
public class CommodityDaoTest extends DatabaseTestCase {
    ...
    public void testFactory() {
        assertThat(CommodityDao.factory().getCount()).isEqualTo(2);
        assertThat(CommodityDao.factory().getInstances(0, Integer.MAX_VALUE)).hasSize(2);
    ...
    public void testGetFirstInstance() {
        assertThat(dao.getFirstInstance().getId()).isEqualTo(1);
    }
