    ...
    <div class="link-list">
        ...
        <div class="content">
            <c:forEach var="indexImageMap" items="${indexImageMaps}">
                <div data-options="id: ${indexImageMap.id}">
                    <div class="comment" title="单击可显示链接对应的区域">${indexImageMap.comment}</div>
                    ...
                    <input type="hidden" name="href" value="${indexImageMap.href}"/>
                </div>
            </c:forEach>
        </div>
    </div>
