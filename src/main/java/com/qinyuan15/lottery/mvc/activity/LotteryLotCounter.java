...
/**
 * Class to count activity lot of certain activity activity
 */
public class LotteryLotCounter {
    /**
     * count the total lot number of certain activity activity,
     * including virtual lot and real lot
     *
     * @param activity activity activity to count
    ...
    /**
     * count the real lot number of certain activity activity
     *
     * @param activityId id of activity to count
     * @return real lot number of the activity activity
     */
    ...
    /**
     * count the read lot number of certain activity activity and certain user
     *
     * @param activityId id of activity to count
     * @param userId     id of user to count
     * @return real lot number of the activity activity and user
     */
